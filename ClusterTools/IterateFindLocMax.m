...
%
% NB2: The algorithm will just find the closest maximal, i.e. largest value (within Search-Distance)!
%      This is called the "local maximum" here although, this is not correct for each step of the iteration.
%      ONLY AFTER iterating this algorithm till clusters do not change any more, one can call the maximum values,
%      i.e. largest values, local maxima, -for clusters of minimally having the distance "SearchDistance".
%
%Outputs:
